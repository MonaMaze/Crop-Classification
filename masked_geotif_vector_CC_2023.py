...
ruv_shp = gpd.read_file('shapefile/RUV_2023.shp')
with fiona.open("shapefile/RUV_2023.shp", "r") as shapefile:
...
with rasterio.open("images/CC_2023/vector_2023.tif", "w", driver = "GTiff", crs = mas_shr.crs, transform = mas_shr.transform, dtype = rasterio.uint8, count = 1,
